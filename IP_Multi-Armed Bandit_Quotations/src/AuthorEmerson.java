...
public class AuthorEmerson extends JPanel {
	...
	public AuthorEmerson() throws IOException {

		authorreader = new Author();
		emersonlist = authorreader.getEmersonList();
		...
		imageemerson
				.setIcon(new ImageIcon("Resources" + System.getProperty("file.separator") + "Emerson-Ralph-Waldo.jpg"));
		...
		name = new JLabel("Your most rated author is: Mr. Ralph-Waldo Emerson");
		...
		for (int i = 0; i < emersonlist.size(); i++) {
			rowData[0] = emersonlist.get(i).getQuoations();
